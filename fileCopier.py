...
parser.add_argument("SourceFolder", help="The folder containing the files you wish to copy from")
parser.add_argument("DestinationFolder", help="The folder where you wish to put the file")
parser.add_argument("CSV", help ="Path to CSV file containing video names and tags")
parser.add_argument("Tag", help="Tag from second column of CSV. When this tag appears in the second column, the video file tagged with it will copy to the destination folder")
